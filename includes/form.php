    ...
    <form method="post" id="add-to-cal-form">
        ...
        <div class="row title">
            ...
            <input type="text" class="regular-text" name="title"
                   placeholder="<?php esc_attr_e( 'Your event title...', 'add-to-cal' ); ?>" value="" required>
            <p class="description"><?php _e( 'The name of your event.', 'add-to-cal' ); ?></p>
        </div>

        <div class="row times">
            <p class="label"><?php _e( 'Event Duration', 'add-to-cal' ); ?></p>
            <input type="date" name="start_date" value="<?php esc_attr_e( date_i18n( 'Y-m-d' ) ); ?>" required><input
                    type="time" name="start_time" value="09:00:00" required>
			<?php _e( 'To', 'add-to-cal' ); ?>
            <input type="date" name="end_date" value="<?php esc_attr_e( date_i18n( 'Y-m-d' ) ); ?>" required><input
                    type="time" name="end_time" value="10:00:00" required>
        ...
        <div class="row description">
            ...
            <textarea name="desc" class="regular-text"
                      placeholder="<?php esc_attr_e( 'Your event description...', 'add-to-cal' ); ?>"
                      rows="4"></textarea>
        ...
        <div class="row location">
            ...
            <input type="text" class="regular-text" name="location"
                   placeholder="<?php esc_attr_e( 'Your event location...', 'add-to-cal' ); ?>" value="">
        ...
        <div class="row text">
            ...
            <input type="text" class="regular-text" name="text"
                   placeholder="<?php esc_attr_e( 'Add To Google Calendar', 'add-to-cal' ); ?>" value="">
